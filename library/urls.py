...
from .views import allbooks,search,addbook,deletebook,issuerequest,myissues,issue_book,return_book,allissues,myfines,allfines,deletefine
urlpatterns = [
